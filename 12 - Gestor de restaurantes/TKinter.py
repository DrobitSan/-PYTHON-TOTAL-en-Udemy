...
def recibo():
    ...
    texto_recibo.insert(END, f'Referencia:\t{num_recibo}\t\t{fecha_recibo}\n')
    ...
    for comida in texto_comida:
        if comida.get() != '0':
            texto_recibo.insert(END, f'{lista_comidas[x].title()}\t\t{comida.get()}\t'
    ...
    for bebida in texto_bebida:
        if bebida.get() != '0':
            texto_recibo.insert(END, f'{lista_bebidas[x].title()}\t\t{bebida.get()}\t'
    ...
    for postre in texto_postre:
        if postre.get() != '0':
            texto_recibo.insert(END, f'{lista_postres[x].title()}\t\t{postre.get()}\t'
    ...
    texto_recibo.insert(END, f'Precio del postre: \t\t\t {var_costo_postre.get()}\n')
    texto_recibo.insert(END, f'-'*54 + '\n')
    texto_recibo.insert(END, f'Sub-total: \t\t\t {var_subtotal.get()}\n')
    texto_recibo.insert(END, f'I.V.A.: \t\t\t {var_impuesto.get()}\n')
...
#panel derecho
panel_dcho= Frame(aplicacion, bd=1, relief= FLAT)
panel_dcho.pack(side=RIGHT)

#panel calculadora
panel_calcu= LabelFrame(panel_dcho, bd=1, relief=FLAT, fg='burlywood') #text='Calculadora', font=('Dosis', 19, 'bold'),
panel_calcu.pack() #si no se pone nada va arriba por defecto

#panel recibo
panel_recibo= LabelFrame(panel_dcho, bd=1, relief=FLAT, fg='burlywood') # text='Recibo', font=('Dosis', 19, 'bold'),
panel_recibo.pack()

#panel botones
panel_botones= LabelFrame(panel_dcho, bd=1, relief=FLAT, fg='burlywood') #text='Botones', font=('Dosis', 19, 'bold'),
panel_botones.pack()
...
#Calculadora
visor_calculadora = Entry(panel_calcu, 
                          font=('Dosis', 16, 'bold'),
                          width=32,
                          bd=1)
